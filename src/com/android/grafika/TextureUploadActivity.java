...
public class TextureUploadActivity extends Activity {
    ...
    private class TextureUploadTask extends AsyncTask<Void, Integer, Long> {
        ...
        private long runTextureTest(OffscreenSurface eglSurface) {
            ...
            Texture2dProgram texProgram = new Texture2dProgram(Texture2dProgram.ProgramType.TEXTURE_2D);
            ...
            for (int iteration = 0; iteration < mIterations; iteration++) {
                ...
                for (int i = 0; i < TEX_PER_ITER; i++) {
                    textureHandles[i] = GlUtil.createImageTexture(mPixelSource[i], mWidth, mHeight, GLES20.GL_RGBA);
                }
                ...
                long trimmedTime = (drawEndNanos - uploadStartNanos) - (redrawEndNanos - drawEndNanos);
                Log.d(TAG, "iter " + iteration + " upload=" + (uploadEndNanos - uploadStartNanos) + " draw=" + (drawEndNanos - uploadEndNanos) + " redraw=" + (redrawEndNanos - drawEndNanos) + " trimmed=" + trimmedTime);
