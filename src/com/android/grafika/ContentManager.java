...
public class ContentManager {
    ...
    private static final int[] ALL_TAGS = new int[]{MOVIE_EIGHT_RECTS, MOVIE_SLIDERS};
    ...
    private static class GenerateTask extends AsyncTask<Void, Integer, Integer> implements ProgressUpdater {
        ...
        private void showFailureDialog(Context context, RuntimeException failure) {
            ...
            String msg = context.getString(R.string.contentGenerationFailedMsg, failure.getMessage());
