 ...
 */
public class ScheduledSwapActivity extends Activity implements OnItemSelectedListener, SurfaceHolder.Callback, Choreographer.FrameCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.scheduledSwapUpdateNames, android.R.layout.simple_spinner_item);
        ...
        adapter = ArrayAdapter.createFromResource(this, R.array.scheduledSwapAheadNames, android.R.layout.simple_spinner_item);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner.setAdapter(adapter);
    ...
    private static class RenderThread extends Thread {
        ...
        private void setParameters(int updatePatternIndex, int framesAheadIndex) {
            if (mUpdatePatternIdx != updatePatternIndex || mFramesAheadIdx != framesAheadIndex) {
        ...
        private boolean advance(long frameTimeNs) {
            ...
            if (mHoldFrames > 1) {
                ...
                mUpdatePatternOffset = (mUpdatePatternOffset + 1) % UPDATE_PATTERNS[mUpdatePatternIdx].length();
            ...
            // handle these.
            if (mPreviousRefreshNs != 0 && frameTimeNs - mPreviousRefreshNs > mRefreshPeriodNs + ONE_MILLISECOND_NS) {
                mChoreographerSkips++;
                complain = true;
                Log.d(TAG, frameTimeNs + ": Choreographer skip: " + ((frameTimeNs - mPreviousRefreshNs) / 1000000.0) + " ms");
            }
        ...
        private void draw() {
            ...
            GLES20.glClearColor(1f, 1f * (mDroppedFrames & 0x01), 1f * (mChoreographerSkips & 0x01), 1f);
            GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT);
    ...
    private static class RenderHandler extends Handler {
        ...
        public void sendSetParameters(int updatePatternIndex, int framesAheadIndex) {
            sendMessage(obtainMessage(RenderHandler.MSG_SET_PARAMETERS, updatePatternIndex, framesAheadIndex));
        }
