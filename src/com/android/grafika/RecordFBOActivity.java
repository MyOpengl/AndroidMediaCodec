...
public class RecordFBOActivity extends Activity implements SurfaceHolder.Callback, Choreographer.FrameCallback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        SurfaceView sv = (SurfaceView) findViewById(R.id.fboActivity_surfaceView);
        mRenderThread = new RenderThread(sv.getHolder(), new ActivityHandler(this), outputFile, MiscUtils.getDisplayRefreshNsec(this));
    ...
    private static class RenderThread extends Thread {
         ...
         */
        public RenderThread(SurfaceHolder holder, ActivityHandler ahandler, File outputFile, long refreshPeriodNs) {
        ...
        private void doFrame(long timeStampNanos) {
            ...
            if (!mRecordingEnabled || mRecordedPrevious) {
                ...
                if (mRecordMethod == RECMETHOD_DRAW_TWICE) {
                ...
                } else if (mEglCore.getGlVersion() >= 3 && mRecordMethod == RECMETHOD_BLIT_FRAMEBUFFER) {
                    ...
                    Log.v(TAG, "glBlitFramebuffer: 0,0," + mWindowSurface.getWidth() + "," + mWindowSurface.getHeight() + "  " + mVideoRect.left + "," + mVideoRect.top + "," + mVideoRect.right + "," + mVideoRect.bottom + "  COLOR_BUFFER GL_NEAREST");
                    GLES30.glBlitFramebuffer(0, 0, mWindowSurface.getWidth(), mWindowSurface.getHeight(), mVideoRect.left, mVideoRect.top, mVideoRect.right, mVideoRect.bottom, GLES30.GL_COLOR_BUFFER_BIT, GLES30.GL_NEAREST);
                    int err;
        ...
        private void update(long timeStampNanos) {
            ...
            if (mPrevTimeNanos == 0) {
                ...
                if (intervalNanos > ONE_SECOND_NANOS) {
                    ...
                    Log.d(TAG, "Time delta too large: " + (double) intervalNanos / ONE_SECOND_NANOS + " sec");
                    intervalNanos = 0;
                }
            }
